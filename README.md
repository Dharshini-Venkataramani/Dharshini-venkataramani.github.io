...
- 🚲 [Citi Bike NYC](https://github.com/Dharshini-Venkataramani/citi_bike_system_project): Cost-Sensitive Demand Prediction : LightGBM (Optuna-tuned) model achieving 36.8% operational cost reduction across 578 hours of live-style evaluation, on an Airflow/Spark/Iceberg pipeline. Deployed to AWS EC2 with a FastAPI backend and Streamlit frontend.
